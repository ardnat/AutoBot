class SelfDiscover:
    ...
    def select_reasoning_modules(self,llmfunc,task_description, reasoning_modules):
        """
        ...
        selected_modules = llmfunc(prompt)
        return selected_modules

    def adapt_reasoning_modules(self,llmfunc,selected_modules, task_example):
        """
        ...
        adapted_modules = llmfunc(prompt)
        return adapted_modules

    def implement_reasoning_structure(self,llmfunc,adapted_modules, task_description):
        """
        ...
        reasoning_structure = llmfunc(prompt)
        return reasoning_structure

    # STAGE 2

    def execute_reasoning_structure(self,llmfunc,reasoning_structure, task_instance):
        """
        ...
        solution = llmfunc(prompt)
        return solution

    def Execute(self,llmfunc,prompt):
        reasoning_modules = [
        ...
        task_example = prompt
        selected_modules = self.select_reasoning_modules(llmfunc,task_example, reasoning_modules)
        print("Stage 1 SELECT: Selected Modules:\n", selected_modules)
        
        adapted_modules = self.adapt_reasoning_modules(llmfunc,selected_modules, task_example)
        print("\nStage 1 ADAPT: Adapted Modules:\n", adapted_modules)
        
        reasoning_structure = self.implement_reasoning_structure(llmfunc,adapted_modules, task_example)
        print("\nStage 1 IMPLEMENT: Reasoning Structure:\n", reasoning_structure)

        result = self.execute_reasoning_structure(llmfunc,reasoning_structure, task_example)
